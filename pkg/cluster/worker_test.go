...
func TestWorkerAdd_RequiresSindNodes(t *testing.T) {
	...
	m.OnCall = func(args []string, _ string) cmdexec.MockResult {
		...
		if args[0] == "exec" && len(args) >= 4 && args[2] == "cat" {
			return cmdexec.MockResult{Err: fmt.Errorf("cat: /etc/slurm/sind-nodes.conf: No such file or directory")}
		}
...
func TestWorkerAdd_AllowsUnmanaged(t *testing.T) {
	...
	m.OnCall = func(args []string, _ string) cmdexec.MockResult {
		...
		if args[0] == "exec" {
			return cmdexec.MockResult{Err: fmt.Errorf("should not be called")}
		}
		return cmdexec.MockResult{}
	}
	client := docker.NewClient(&m)
...
func TestWorkerAdd_ListContainersError(t *testing.T) {
	...
	m.OnCall = func(args []string, _ string) cmdexec.MockResult {
		if args[0] == "ps" {
			return cmdexec.MockResult{Err: fmt.Errorf("docker daemon not running")}
		}
		return cmdexec.MockResult{}
	}
	client := docker.NewClient(&m)
...
func TestNextComputeIndex_Sequential(t *testing.T) {
	...
	m.OnCall = func(args []string, _ string) cmdexec.MockResult {
		if args[0] == "ps" {
			return cmdexec.MockResult{Stdout: workerContainers("worker-0", "worker-1")}
		}
		return cmdexec.MockResult{}
	}
	client := docker.NewClient(&m)
...
func TestNextComputeIndex_Gap(t *testing.T) {
	...
	m.OnCall = func(args []string, _ string) cmdexec.MockResult {
		if args[0] == "ps" {
			return cmdexec.MockResult{Stdout: workerContainers("worker-0", "worker-3")}
		}
		return cmdexec.MockResult{}
	}
	client := docker.NewClient(&m)
...
func workerAddOnCall(t *testing.T) func([]string, string) cmdexec.MockResult {
	t.Helper()
	...
	return func(args []string, _ string) cmdexec.MockResult {
		...
		case args[0] == "ps":
			return cmdexec.MockResult{Stdout: workerContainers("worker-0")}
		...
		case args[0] == "inspect" && args[1] == "sind-dev-controller":
			return cmdexec.MockResult{Stdout: inspectJSONLabels(t, "sind-dev-controller", "running",
		...
		case args[0] == "exec" && args[1] == "sind-dev-controller" && len(args) > 2 && args[2] == "cat":
			return cmdexec.MockResult{Stdout: nodesConf}
		...
		// CreateContainer
		case args[0] == "create":
			return cmdexec.MockResult{Stdout: "new-cid\n"}
...
func workerRemoveOnCall(t *testing.T, nodesConf string) func([]string, string) cmdexec.MockResult {
	t.Helper()
	...
	return func(args []string, _ string) cmdexec.MockResult {
		...
		case args[0] == "exec" && args[1] == "sind-dev-controller" && len(args) > 2 && args[2] == "cat":
			if nodesConf == "" {
				return cmdexec.MockResult{Err: fmt.Errorf("No such file")}
			}
			return cmdexec.MockResult{Stdout: nodesConf}
		...
		case args[0] == "exec" && args[1] == "sind-ssh":
			return cmdexec.MockResult{Stdout: "worker-1.dev.sind.sind ssh-ed25519 AAAA\n"}
...
func TestWorkerAdd_CreateNodeError(t *testing.T) {
	...
	m.OnCall = func(args []string, stdin string) cmdexec.MockResult {
		if args[0] == "create" {
			return cmdexec.MockResult{Err: fmt.Errorf("image not found")}
		}
		return inner(args, stdin)
	}
	client := docker.NewClient(&m)
...
func TestWorkerAdd_RegisterNodesError(t *testing.T) {
	...
	m.OnCall = func(args []string, stdin string) cmdexec.MockResult {
		...
		if args[0] == "cp" && len(args) == 3 && args[2] == "-" && strings.Contains(args[1], "sind-dns") {
			return cmdexec.MockResult{Err: fmt.Errorf("DNS container crashed")}
		}
		return inner(args, stdin)
	}
	client := docker.NewClient(&m)
...
func TestWorkerAdd_UpdateNodesConfReadError(t *testing.T) {
	...
	m.OnCall = func(args []string, stdin string) cmdexec.MockResult {
		if args[0] == "exec" && args[1] == "sind-dev-controller" && len(args) > 2 && args[2] == "cat" &&
			...
			readCount++
			if readCount >= 2 {
				return cmdexec.MockResult{Err: fmt.Errorf("file disappeared")}
			}
		}
		return inner(args, stdin)
	}
...
func TestWorkerAdd_WriteNodesConfError(t *testing.T) {
	...
	m.OnCall = func(args []string, stdin string) cmdexec.MockResult {
		if args[0] == "exec" && args[1] == "-i" &&
			...
			return cmdexec.MockResult{Err: fmt.Errorf("disk full")}
		}
		return inner(args, stdin)
	}
	client := docker.NewClient(&m)
...
func workerLifecycleOnCall(t *testing.T) func([]string, string) cmdexec.MockResult {
	t.Helper()
