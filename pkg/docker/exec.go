...
// MockCall records a single invocation of MockExecutor.Run.
type MockCall struct {
	Name string
	Args []string
}

// MockResult holds the return values for a single MockExecutor.Run call.
...
// AddResult enqueues a result to be returned by the next Run call.
